...
* 有条件响应：对于传播方而言，并非希望所有的事件都一视同仁的广播出去；对于消费方而言，也并不希望一视同仁的响应所有的事件

...
* 重构遗留工作
  * 目录整理 - components
    * @/components/components（已完成）
    * @/components/config（已完成）
    * @/components/hooks（已完成）
    * @/components/models（已完成）
    * @/components/utils（已完成）
    * 指标 Indicator 相关增加上一层分类（已完成）
  * 可能通用化的组件
    * AnglePicker（已完成）
    * PanelTitle（已完成）
    * BasicConditions

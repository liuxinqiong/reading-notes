...
* [eggjs工程与分析](https://mp.weixin.qq.com/s/9T_ouZuhGeDAxLwzd_jRrw)
  * egg 入门
* [精读《Compilers are the New Frameworks》](https://zhuanlan.zhihu.com/p/34931049)
  * JIT & WebAssembly
* [老年用户的体验思考](https://zhuanlan.zhihu.com/p/34722444)
  * 站在用户角度
* [创业公司增长指南：如何建立，完善和规模化一个增长计划](https://0.61803398875.xyz/2017/08/04/growth-guide-2017.html)
* [gitlab-tree — gitlab代码查看必备神器](https://qianduan.group/posts/5ab1175764073b4a0b00ca13)
...
* [关于移动开发技术走势的思考](https://mp.weixin.qq.com/s/wZ70sjGlAF4Phb8xv2d7Gg)
* [我是一个“栈”](https://mp.weixin.qq.com/s/uDcD-574ZvgRKu_mg4LVJw)
  * 比较浅显有趣的解释，看看别人怎么表达的，哈哈
* [Websocket 使用指南](https://qiutc.me/post/websocket-guide.html)
* [Nerv - 京东高性能前端框架](https://aotu.io/notes/2018/03/22/nerv/)
...
* [微服务下使用GraphQL构建BFF](https://insights.thoughtworks.cn/use-graphql-build-bff-in-microservices/)
  * GraphQL 这玩意真的很棒，以后会是潮流
* [pwa, 上海地铁线路图全新重构](https://madneal.com/post/pwa-上海地铁线路图全新重构/)
  * React 实践
* [PC端MPA和移动端SPA的路由同构](https://mp.weixin.qq.com/s/ICcYIcK9cBFqrQTQw-xKEQ)
* [应届毕业生应该怎样写简历？](https://hacpai.com/article/1522149387686)
* [MyBatis解析XML标签及占位符相关源码剖析](https://mp.weixin.qq.com/s/dCiuWf6_eCpBaTj4MHPf8Q)
...
* [区块链系列二：区块链涉及到的密码学知识之Hash](https://mp.weixin.qq.com/s/4s_M7lmfLRC-ZInWQENARQ)
  * 非常不错的资料
* [前端到底要不要算法？](https://mp.weixin.qq.com/s/KrGgtITKAIUKxs06ljUS7g)
  * 算法应该不分前后端吧
* [快应用教程-实现自定义组件](https://www.jianshu.com/p/6e8295c99dc5)
  * 这玩意和vue很像啊
* [从头实现一个koa框架](https://segmentfault.com/a/1190000014044408)
  * 想学的，好多呀
* [Nicon-支持私有部署的开源字体图标管理平台！](https://qianduan.group/posts/5ab9e22964073b4a0b00ca1d)
* [HTTP协议冷知识大全](https://mp.weixin.qq.com/s/aekcsgLG6jZw3LeF3R9ssQ)
  * 这tm哪里是冷知识，简直就是基础知识，但是写的很好
...
* [从抄书到开源之巅：章亦春的程序人生](https://mp.weixin.qq.com/s/moyoJd1EnNziRPQgHbNXRw)
  * 默默膜拜一下大神的成长
* [你真的会打 Log 吗？](https://mp.weixin.qq.com/s/kjt24edO2WyiB66fTgZPAw)
  * 日志的重要性
  * 日志的规范